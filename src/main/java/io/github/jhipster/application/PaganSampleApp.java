...
public class PaganSampleApp {

    private static final Logger log = LoggerFactory.getLogger(PaganSampleApp.class);

    private final Environment env;

    public PaganSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes PaganSampleApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PaganSampleApp.class);
